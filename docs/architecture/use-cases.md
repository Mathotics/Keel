...
* **Make an existing issue repeating.** A user opens Make this repeating on the issue; the recipe is an overlay, not a panel on the page. That issue becomes the first occurrence ([ADR 023](../adr/ADR-023.md)).
