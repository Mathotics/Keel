...
> **Amendment.** Priority is stored on the series recipe and copied onto spawned issues ([ADR 032](ADR-032.md)). The original out-of-scope note below is historical.
...
* [ADR 032: Series recipe priority](ADR-032.md)
