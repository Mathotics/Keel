...
* **Must Not** provide a bulk delete of every issue in the series in this feature. Delete of the series is the way to end the recipe ([ADR 023](ADR-023.md)); spawned issues remain. Delete on an issue is this occurrence only.
...
* [ADR 023: Delete a schedule without deleting spawned issues](ADR-023.md)
