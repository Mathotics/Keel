...
* **Status:** Accepted, amended by [ADR 023](ADR-023.md)
* **Date:** 2026-09-14

> **Amended 2026-09-14.** The issue-page recipe is no longer an always-open panel. **Make this repeating** and **Edit series** open the same form in a same-page overlay ([ADR 023](ADR-023.md)). Schedules pages are unchanged.
...
* [ADR 023: Issue-page repeating recipe in an overlay](ADR-023.md)
