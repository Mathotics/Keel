...
- Menu items besides the home icon (no “Keel” wordmark, Docs, Health, or placeholders in this version).
...
- Persistent sticky top menu on Keel HTML pages, icon-only, linking home.
...
* **Must Not** add other menu destinations or labels in this version.
