...
- Lines for actual changes to **status**, **assignee**, **sprint**, **estimate**, **remaining**, **due date**, **parent**, **type**, **title**, **description**, and **priority**.
...
* **Must** append a line only when an in-scope field’s value actually changes: status, assignee, sprint, estimate, remaining, due date, parent, type, title, description, priority.
