...
> **Amendment.** Title and description changes are recorded the same way as the other in-scope fields.
>
> **Amendment.** [ADR 030](ADR-030.md) records priority changes on the same trail.
>
> **Amendment.** Label-set changes are recorded as field `labels` ([ADR 031](ADR-031.md)).
...
- Lines for actual changes to **status**, **assignee**, **sprint**, **estimate**, **remaining**, **due date**, **parent**, **type**, **title**, **description**, **priority**, and **labels**.
...
* **Must** append a line only when an in-scope field’s value actually changes: status, assignee, sprint, estimate, remaining, due date, parent, type, title, description, priority, labels.
