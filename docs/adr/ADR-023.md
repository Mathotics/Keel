...
- Two items: **FastAPI Docs** ΓåÆ `/docs`, **ReDoc** ΓåÆ `/redoc`.
...
* **Risk:** Opening stock FastAPI pages in a new tab can look like a different product (no Keel chrome). Native disclosure may stay open or not match a typical ΓÇ£click outside to closeΓÇ¥ menu.
