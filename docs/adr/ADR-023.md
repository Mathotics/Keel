# ADR 023: Delete a schedule without deleting spawned issues
...
Same product surfaces as ADR 021: project **Schedules** list and detail in the top nav family, issue repeating panel, ambient identity. Pause and Resume stay on the detail page; Stop is replaced by Delete. Spawned work remains ordinary issues. Persistence of the former-series note is not specified here.
