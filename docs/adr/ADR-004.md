...
> **Extension.** [ADR 013](ADR-013.md) fixes the labels this ADR deliberately left open — *To Do*, *In Progress*, *In Review*, *Blocked*, *Done* — and records that the set is realized as an enumeration in code rather than as stored records.
