...
* **Status:** Accepted, amended by [ADR 018](ADR-018.md)
* **Date:** 2026-09-08

> **Amended 2026-09-08.** On a phone-narrow viewport the footer sits at the end of the page instead of staying pinned to the bottom of the window, so it does not cover the board or forms. Wide viewports keep this record’s pinned footer. See [ADR 018](ADR-018.md).
...
* **Must** keep the footer visible at the bottom of the viewport when the page is taller than the window (content scrolls; footer stays), on a wide viewport. On a phone-narrow viewport the footer is at the end of the page instead ([ADR 018](ADR-018.md)).
